...
import StyledPegaCustomComponentsMyDetailsTemplateWrapper from './styles';

// includes in bundle
import { getAllFields } from './utils';

// interface for props
interface PegaCustomComponentsMyDetailsTemplateProps extends PConnFieldProps {
...
export default function PegaCustomComponentsMyDetailsTemplate(
  props: PegaCustomComponentsMyDetailsTemplateProps
) {
  ...
  return (
    <StyledPegaCustomComponentsMyDetailsTemplateWrapper>
      <FieldGroup name={propsToUse.showLabel ? propsToUse.label : ''}>
        {showHighlightedData && highlightedDataArr.length > 0 && (
          <Grid
            container={gridHighlightContainer}
...
PegaCustomComponentsMyDetailsTemplate.defaultProps = {
  label: undefined,
  showLabel: true,
  showHighlightedData: false
};

PegaCustomComponentsMyDetailsTemplate.propTypes = {
