import PegaCustomComponentsMyLocalActionLauncher from './index.tsx';

export default {
  title: 'PegaCustomComponentsMyLocalActionLauncher',
  component: PegaCustomComponentsMyLocalActionLauncher
};
...
export const basePegaCustomComponentsMyLocalActionLauncher = () => {
  // ②
  const props = {
    buttonText: 'Test',
    testId: '123456',
  ...
  return <PegaCustomComponentsMyLocalActionLauncher {...props} />;
};
